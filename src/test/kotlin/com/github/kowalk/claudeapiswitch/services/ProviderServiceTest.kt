...
class ProviderServiceTest {
    ...
    fun testStripAllRemovesForeignEnvVarsOutsideMarkers() {
        ...
        val result = service.stripAllClaudeEnvVars(content, false)
    ...
    fun testStripAllCleansPowerShellForeignVars() {
        ...
        val result = service.stripAllClaudeEnvVars(content, true)
    ...
    fun testRemoveMarkerBlockStripsUnsetBlock() {
        // When the IDE was launched with stale DeepSeek env vars, the plugin writes
        // an unset block. Switch-back-to-DeepSeek must still strip this block.
        val content = """
            export PATH=/usr/bin
            # claude-api-switch
    ...
    fun testStripAllDoesNotStripUnsetCommandsOutsideBlock() {
        // User could have manual unset commands outside our markers; these are
